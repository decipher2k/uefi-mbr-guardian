...
/*
 * font8x16.h - Embedded 8x16 bitmap font (CP437 / VGA style)
 * Covers ASCII 0x20 (space) through 0x7E (~), 95 glyphs.
 * Each glyph is 16 bytes (one byte per row, MSB = left pixel).
 */
...
static const UINT8 font8x16_data[FONT_GLYPHS][16] = {
...
/* Extended characters for box drawing (manual) */
/* We use simple ASCII for menus instead */
